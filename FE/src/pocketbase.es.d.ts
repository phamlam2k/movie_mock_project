/**
 * file pocketbase.es.d.ts dc custom lại
 * link thực hiện tạo client id và client key: https://www.youtube.com/watch?v=0KoZSVnTnkA
 * **/
...
declare abstract class BaseCrudService<
  M extends BaseModel
> extends BaseService {
  /**
...
declare abstract class SubCrudService<
  M extends BaseModel
> extends BaseCrudService<M> {
  /**
